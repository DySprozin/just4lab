...
class Cls_Topic {
 ...
 public function __construct($username="") {
  ...
  $this->chmods = '';
  $ingroup_path = ROOT . 'conf/topic/groups/';
...
class Cls_Topic_Items extends Cls_Topic {
 ##
...
*/
 ...
 public function topic() {
  ...
  if ($this->active == 'off') {
   $link = <<< LINK
   <!--$this->chmods--> <a class="right_link_kva" href="/topic/$this->f/" title='$this->a_title'>$this->title</a> $this->title2
LINK;
  }
  else {
   $link = <<< LINK
